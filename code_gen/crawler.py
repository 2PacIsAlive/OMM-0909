...
class PoemCrawler():
	def __init__(self):
		self.urls  = ['www.cppsamples.com/']  #['www.poets.org/poetsorg/poem/history', 'www.poets.org/poetsorg/poem/american-sonnet-10' ]
		self.soup  = None
		self.poems = list()
...
crawler = PoemCrawler()
crawler.getSoup('www.cppsamples.com/common-tasks/weak-reference.html')
crawler.findPoems()
print crawler.soup.prettify().text
